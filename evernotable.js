(function(){
    ...
    function integrateElements(){
        var parts = document.getElementsByClassName('css-901oao r-hkyrab r-1blvdjr r-16dba41 r-ad9z0x r-bcqeeo r-bnwqim r-qvutc0');
        if (parts.length == 0) {
            return;
        }
        var parts2 = document.getElementsByClassName('css-1dbjc4n r-9x6qib r-t23y2h r-1phboty r-rs99b7 r-156q2ks r-1udh08x');
    ...
    removeElements('css-1dbjc4n r-1loqt21 r-16y2uox r-1wbh5a2 r-1ny4l3l r-1udh08x r-1j3t67a r-o7ynqc r-6416eg'); // reply
